...
SWIFT_CLASS("_TtC23DKImagePickerController22DKImageExtensionCamera")
@interface DKImageExtensionCamera : DKImageBaseExtension
@end
...
SWIFT_CLASS("_TtC23DKImagePickerController28DKImageExtensionInlineCamera")
@interface DKImageExtensionInlineCamera : DKImageBaseExtension
@end
...
SWIFT_CLASS("_TtC23DKImagePickerController28DKImageExtensionPhotoCropper")
@interface DKImageExtensionPhotoCropper : DKImageBaseExtension
@end
